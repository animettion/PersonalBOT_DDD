...
namespace PersonalBot.Repository
{
    public class AparelhoRepository : IAparelhoRepository
    {
        ...
        public List<Aparelho> getAparelhos()
        {
            ...
            //lista_Aparelhos.Add(new Aparelho(31, "Remada", "Remada.jpg"));
            //lista_Aparelhos.Add(new Aparelho(32, "Cadeira Flexora", "Flexora.jpg"));
            //lista_Aparelhos.Add(new Aparelho(23, "Abdominal supra reto", "Abdominal.jpg"));
            //lista_Aparelhos.Add(new Aparelho(24, "Lombar", "Lombar.jpg"));
