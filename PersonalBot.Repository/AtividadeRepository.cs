...
namespace PersonalBot.Repository
{
    public class AtividadeRepository : IAtividadeRepository
    {
        public List<Atividade> GetAtividades()
        {
            ...
            lista_atividades.Add(new Atividade(Guid.NewGuid(), "Leg press 45", TipoAtividade.Moderado, ap.getAparelho(35), "Série: 3x de 6-8 repetições" + System.Environment.NewLine + "Carga: moderada" + System.Environment.NewLine + "Descanso: 1-2 min"));
            ...
            lista_atividades.Add(new Atividade(Guid.NewGuid(), "Crunch", TipoAtividade.Monstro, ap.getAparelho(35), "Série: 2x de 10 a 12 repetições" + System.Environment.NewLine + " Carga: leve" + System.Environment.NewLine + "Descanso: 1-2 min"));
